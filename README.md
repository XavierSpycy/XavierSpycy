...
- Research Experiences:
  - *Top*ic *M*odeling for the *E*volution through *D*escriptions of *A*pplications *L*ongitudina (*TopMEDAL*)
  - Cross-modal medical image representation learning (<u>*VRI Scholarship*</u>)
...
<ul>
  <li><a href="#numpy-based-projects">NumPy-Based Projects</a>
    <ul>
      <li><a href="#self-developed-library-using-numpy">Self-Developed Library</a></li>
      <li><a href="#star-multilayer-perceptron-from-scratch-using-numpy">Multilayer Perceptron from Scratch</a></li>
      <li><a href="#star-non-negative-matrix-factorization-using-numpy">Non-negative Matrix Factorization</a></li>
    </ul>
</li>
  <li><a href="#pytorch-based-projects">PyTorch-Based Projects</a>
    <ul>
        ...
        <li><a href="#star-cat-a-visual-text-multimodal-classifier">Image-Text Multimodal Classification</a></li>
        <li><a href="#star-robust-traniners-for-noisy-labels">Robust Trainers for Noisy Labels</a></li>
    </ul>
  </li>
  <li><a href="#tensorflow-based-projects">TensorFlow-Based Projects</a>
    <ul>
      <li><a href="#star-awesome-tutorials-for-tensorflow2">Awesome Tutorials for TensorFlow2</a></li>
    </ul>
  </li>
</ul>
...
<details>
  ...
  <details>
    <summary id="self-developed-library-using-numpy">
